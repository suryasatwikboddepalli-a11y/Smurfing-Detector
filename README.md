# Smurfing Detection: A Temporal Graph-Theoretic Framework for Detecting Illicit Topologies in Account-Based Blockchains
...
│   └── smurfing_detector/
│       ├── core/
│       │   ├── smurfing_detector.py   # Main analysis logic
